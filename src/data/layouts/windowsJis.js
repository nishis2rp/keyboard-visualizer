...
export const windowsJisLayout = [
  ...
  [
    ...
    { key: 'PrintScreen', code: 'PrintScreen', display: 'PrtSc', width: 1 }, // 追加
    { key: 'ScrollLock', code: 'ScrollLock', display: 'ScLk', width: 1 },   // 追加
    { key: 'Pause', code: 'Pause', display: 'Pause', width: 1 },           // 追加
  ],
  // 2行目
  [
    { key: 'Backquote', code: 'Backquote', display: '`', width: 1 }, // 半角/全角
    ...
    { key: 'Equal', code: 'Equal', display: '^', width: 1 }, // JISでは ^
    { key: 'IntlYen', code: 'IntlYen', display: '¥', width: 1 }, // JIS固有
    { key: 'Backspace', code: 'Backspace', display: 'Back', width: 2 }, // 幅を調整
  ],
  // 3行目
  [
    ...
    { key: 'BracketLeft', code: 'BracketLeft', display: '@', width: 1 }, // JISでは @
    { key: 'BracketRight', code: 'BracketRight', display: '[', width: 1 }, // JISでは [
  ...
  [
    ...
    { key: 'Quote', code: 'Quote', display: ':', width: 1 }, // JISでは :
    { key: 'IntlRo', code: 'IntlRo', display: ']', width: 1 }, // JISでは ]
  ],
  // 5行目
  [
  ...
  [
    ...
    { key: 'KanaMode', code: 'KanaMode', display: 'かな', width: 1 }, // JIS固有
