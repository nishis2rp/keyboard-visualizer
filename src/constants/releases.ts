...
export const releases: Release[] = [
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.23.0-weakness-drill',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.23.0-detailed-feedback',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.23.0-bookmarks',
      ...
      },
      {
        ...
        descriptionKey: 'v3.23.0-custom-ids',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.23.0-typescript-fixes',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'improvement',
        descriptionKey: 'v3.22.0-refactor',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.22.0-i18n-logic',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.22.0-os-detect',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.22.0-type-safety',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.21.0-dashboard',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.21.0-conflict-detect',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.21.0-macos-fix',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.21.0-performance-viz',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.20.0-og-image',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.20.0-icon-hover',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.20.0-icon-color',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.19.0-testimonials',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.19.0-responsive-scaling',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.19.0-color-theme',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.19.0-particles',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.19.0-ctrl-cv-fix',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.18.0-seo-component',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.18.0-english-meta',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.18.0-sitemap',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.18.0-manifest',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.18.0-history-refactor',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'improvement',
        descriptionKey: 'v3.17.0-header-buttons',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.17.0-language-selector',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.17.0-layout-width',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.17.0-button-sizing',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.17.0-csv-button',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.17.0-string-literal',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.16.0-dynamic-lp',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.16.0-lp-layout',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.16.0-constellation',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.16.0-version-badge',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.15.0-password-strength',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.15.0-auth-ux',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.15.0-account-settings',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.15.0-accessibility',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.15.0-alternative-shortcuts',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.15.0-vscode-filter',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.15.0-modal-position',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.14.0-windows-us',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.14.0-refactor',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.13.0-tailwind',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.13.0-auth-fix',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.12.0-progress',
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.12.0-profile',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.12.0-db-config',
      ...
      {
        category: 'breaking',
        descriptionKey: 'v3.12.0-breaking',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.10.0-pagekeys',
  ...
  },
  {
    ...
    changes: [
      {
        category: 'feature',
        descriptionKey: 'v3.9.0-supabase',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.9.0-sequential',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.11.0-difficulty-filter',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.8.0-sequential-ui',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.8.0-kbd-layout',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.8.0-nav-keys',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.6.0-macos-shortcuts',
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.6.0-protection',
      ...
      {
        category: 'fix',
        descriptionKey: 'v3.6.0-key-stuck',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.5.0-fullscreen',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'improvement',
        descriptionKey: 'v3.3.0-component',
  ...
  },
  {
    ...
    changes: [
      ...
      {
        category: 'feature',
        descriptionKey: 'v3.2.0-windows11',
