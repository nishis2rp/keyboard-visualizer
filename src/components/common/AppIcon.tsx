  ...
  const renderIcon = () => {
    switch (appId) {
      ...
      case 'vscode':
        return (
          <svg viewBox="0 0 24 24" style={iconStyle} className={className} fill="currentColor">
            <path d="M23.15 2.58L17.62 0l-1.06.75L10.79 5.5 2.86 6.53l-2.06.58V16.9l2.06.58 7.93 1.03 5.77 4.75 1.06.75 5.53-2.58L24 21.09V2.91l-.85-.33zM17.45 18.87l-4.96-3.3 4.96-3.3v6.6zM3.12 11.32l1.96-1.45 1.96 1.45-1.96 1.45-1.96-1.45z" />
          </svg>
        );
      case 'terminal':
        return (
