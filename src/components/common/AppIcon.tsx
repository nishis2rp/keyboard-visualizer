  ...
  const renderIcon = () => {
    switch (appId) {
      ...
      case 'mac-us':
        return (
          <svg viewBox="0 0 24 24" style={iconStyle} className={className} fill="currentColor">
            <path d="M17.5 14c-.01 2.34 2.04 3.47 2.14 3.53-.02.06-.33 1.14-1.11 2.27-.67.98-1.37 1.96-2.48 1.98-1.08.02-1.43-.64-2.66-.64-1.24 0-1.63.62-2.67.66-1.08.04-1.88-1.06-2.55-2.04-1.37-1.98-2.42-5.61-1.01-8.05.7-1.21 1.94-1.98 3.28-2 .88 0 1.83.65 2.5.65.65 0 1.83-.81 2.92-.7.46.02 1.74.19 2.57 1.41-.07.04-1.53.89-1.51 2.66zM14.5 4.5c.6-1.1 1.4-1.8 1.4-1.8s-.8-.1-1.9.6c-1.1.7-1.6 1.8-1.6 1.8s.8.1 1.9-.6h.2z" />
          </svg>
        );
      case 'chrome':
        return (
      ...
      case 'vscode':
        return (
          <svg viewBox="0 0 24 24" style={iconStyle} className={className} fill="currentColor">
            <path d="M23.15 2.58l-5.53-2.58L11.56.75 6.53 4.86 2.86 6.53l-2.06.58V16.9l2.06.58 3.67 1.67 5.03 4.11 1.06.75 5.53-2.58.85-.33V2.91l-.85-.33zM17.45 18.87l-4.96-3.3 4.96-3.3v6.6z" />
          </svg>
        );
      case 'terminal':
        return (
