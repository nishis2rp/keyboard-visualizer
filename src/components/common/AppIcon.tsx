  ...
  const renderIcon = () => {
    switch (appId) {
      ...
      case 'mac-us':
        return (
          <svg viewBox="0 0 24 24" style={iconStyle} className={className} fill="currentColor">
            <path d="M17.057 12.763c.067 2.104 1.812 2.865 1.857 2.887-.028.093-.299.99-.927 2.041-.538.885-1.095 1.765-2.015 1.783-.903.015-1.196-.58-2.228-.58-1.03 0-1.353.564-2.21.581-.856.017-1.49-.945-2.033-1.827-1.106-1.794-1.953-5.072-.814-6.703.566-.81 1.391-1.324 2.29-1.34.856-.015 1.657.63 2.18.63.522 0 1.54-.787 2.598-.675.44.019 1.677.19 2.474 1.442-.066.04-.1.06-.1.06zM11.8 1.5c-.456.556-.763 1.33-.675 2.102.77.06 1.544-.42 2.001-.976.456-.556.763-1.33.675-2.102-.77-.06-1.544.42-2.001.976z" />
          </svg>
        );
      case 'chrome':
        return (
      ...
      case 'vscode':
        return (
          <svg viewBox="0 0 24 24" style={iconStyle} className={className} fill="currentColor">
            <path d="M12.002 0L0 16.59l4.5 3.41L12.002 8l7.5 11.96 4.5-3.41L12.002 0z" />
          </svg>
        );
      case 'terminal':
        return (
