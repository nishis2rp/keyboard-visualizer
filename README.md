...
| **Gmail** | 82 | Basic, Standard, Madmax | メール操作（ナビゲーション、ラベル、フォーマット、選択など） |

**難易度分布（全体）:**
- 🌟 Basic: 144個 (14%) - 日常的に使う基本操作
- ⚡ Standard: 770個 (72%) - 標準的なショートカット
- 🔥 Hard: 79個 (7%) - 高度な機能・専門的な操作
- 💀 Madmax: 73個 (7%) - 超上級者向け（VBA、マクロ、Gmail順押しナビゲーション、フォーマット操作など）
